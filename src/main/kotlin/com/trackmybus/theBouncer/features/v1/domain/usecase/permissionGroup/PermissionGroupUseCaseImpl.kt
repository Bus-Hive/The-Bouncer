...
class PermissionGroupUseCaseImpl(
    ...
    override suspend fun removePermissionGroup(permissionGroupId: Int): Result<Boolean> {
    ...
    override suspend fun assignPermissionToGroup(
        ...
        return permissionGroupRepository.addPermissionToGroup(permissionGroupId, permissionId)
    }
    ...
    override suspend fun getPermissionGroup(permissionGroupId: Int): Result<PermissionGroupDto?> {
    ...
    override suspend fun getPermissionGroups(): Result<List<PermissionGroupDto>> {
    ...
    override suspend fun getBasePermissionGroups(): Result<List<PermissionGroupDto>> {
    ...
    override suspend fun getPermissionGroupsByUserId(userId: String): Result<List<PermissionGroupDto>> {
    ...
    override suspend fun assignUserToGroup(
        ...
        return userPermissionRepository.add(
            UserPermissionGroup(
